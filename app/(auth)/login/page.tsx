...
export default function LoginPage() {
  ...
  const [bgIndex] = useState(() => Math.floor(Math.random() * AUTH_LOGIN_BG.length));
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div>
            ...
            <p className="text-white/45 text-sm max-w-sm leading-relaxed">
              Join 12,400+ photographers building careers, finding clients, and sharing work
          ...
          <div className="flex gap-3 flex-wrap">
            {[
              ...
              { value: formatMoneyCompact(SITE_STATS.platformEarnings), label: "Paid out" },
        ...
        <div className="relative z-10 max-w-md w-full mx-auto">
            ...
            {(["client", "photographer"] as const).map((r) => (
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl text-sm font-semibold capitalize transition-all duration-300 ${
                  role === r ? "text-white shadow-lg" : "text-white/35 hover:text-white/60"
                }`}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl text-sm font-bold text-white transition-all mt-2 relative overflow-hidden"
              style={
                done
                  ? gradSuccess
                  : {
          ...
          <p className="text-center text-[11px] text-white/18 mt-4 leading-relaxed">
            ...
            <button type="button" className="text-white/35 hover:text-white/60 underline transition-colors">
              Terms of Service
            </button>{" "}
            and{" "}
            <button type="button" className="text-white/35 hover:text-white/60 underline transition-colors">
