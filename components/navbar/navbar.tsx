          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                >
                  <Search size={14} className="text-white/40 group-hover:text-white/70 transition-colors" />
                ...
                <Link href="/signup">
                  <GradBtn className="px-4 py-2 rounded-xl text-sm">Get Started</GradBtn>
                </Link>
              </div>
              ...
              <div className="md:hidden flex items-center gap-2">
                ...
                <button
                    onClick={() => { setNotifOpen((v) => !v); setSearchOpen(false); setOpen(false); }}
